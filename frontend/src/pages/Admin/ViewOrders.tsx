...
const ViewOrders: React.FC<ViewOrdersProps> = ({ setIsAdminAuthenticated }) => {
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const groupedOrders = data.reduce((acc: any, curr: any) => {
        const existingOrder = acc.find((order: any) => order.id === curr.id);
        if (existingOrder) {
